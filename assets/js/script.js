...
function handleFormSubmit(event) {
  ...
  shoppingListItemEl.append(
    '<button class="btn btn-danger btn-small delete-item-btn" onclick="removeListItem(event)">Remove</button>'
  );
...
// able to comment this due to adding to line 21(onclick="removeListItem(event))
//shoppingListEl.on('click', '.delete-item-btn', removeListItem)
